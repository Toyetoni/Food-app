  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className=' lg:flex items-center bg-gray-200 rounded-full text-[14px] p-1'>
          <p className='bg-black text-white rounded-full p-2'>Delivery
          </p>
      ...
      <div className='flex items-center bg-gray-200 rounded-full px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
        ...
        <input type="text" placeholder='search foods' className='gb-transparent p-2 w-full focus:outline-none' />


        <button className='bg-black text-white md:flex items-center rounded-full px-5 py-2'>
      ...
      {/* mobile menu */}
      {/* overlay  */}
      {nav ? <div className='bg-black/80 fixed w-full h-screen top-0 left-0 z-10'>
      </div> : ""}
